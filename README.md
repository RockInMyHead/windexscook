...
- **Безопасные API запросы** через HTTPS
...
- **Новые кухни мира** и их особенности
...
### Документация
- **Wiki** с подробными инструкциями
...
*Pastel Chef AI — ваш персональный кулинарный помощник в эпоху искусственного интеллекта*