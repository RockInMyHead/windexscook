...
- Для поля "instructions": сформируй подробную карту производства блюда, разбив процесс на этапы и подэтапы. Для каждого подшага указывай:
  * необходимое оборудование
  * уровень огня и температуру
  * точное время (минуты и секунды)
  * технику выполнения (форма нарезки, интенсивность помешивания и т.д.)
  * обоснование, зачем этот шаг важен
