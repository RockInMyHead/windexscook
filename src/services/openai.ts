...
2. Для каждого этапа укажи:
   ...
   - Время, которое займет каждый шаг.
   - Детальное описание техники выполнения (температура, интенсивность огня, способ нарезки и т.д.).
3. Давай инструкции так, будто говоришь человеку, который почти не готовил: объясняй каждое действие просто и ясно.
