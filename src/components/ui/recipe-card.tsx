...
export const RecipeCard: React.FC<RecipeCardProps> = ({
  ...
  return (
    <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col gap-3 sm:gap-4 lg:gap-5 p-4 sm:p-6 lg:p-8 pt-0">
        {/* Recipe info - Row 1 */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-4 lg:gap-6 text-xs sm:text-sm lg:text-base text-muted-foreground h-8">
        ...
        {/* Category and difficulty - Row 2 */}
        <div className="flex flex-wrap items-center gap-1 sm:gap-2 lg:gap-3 h-8">
        ...
        {/* Author info - Row 3 */}
        <div className="flex items-center gap-2 lg:gap-3 h-8">
        ...
        {/* Action buttons - Row 5 (auto height) */}
