...
Ответь в формате JSON:
{
  ...
  static async chatWithChef(message: string, healthProfile?: UserHealthProfile): Promise<string> {
    const prompt = `Ты - профессиональный Windex кулинар с 20-летним опытом работы на кухне, рейтинг Top-1, знаешь все тонкости продуктов и техник.
...
4. Формулируй инструкции так, будто говоришь человеку, который почти не готовил: объясняй подробно каждое действие, шаг за шагом.
